...
$row = mysqli_fetch_assoc($result);
        ...
        $response16 = $row["imovelTratado"];
        $response17 = $row["quantidadeLarvicida"];
        $response18 = $row["depositoTratado"];
        $response19 = $row["observacao"];
        $response20 = $row["terminoQuarteirao"];
...
$response["imovelTratado"] = $response16;
$response["quantidadeLarvicida"] = $response17;
$response["depositoTratado"] = $response18;
$response["observacao"] = $response19;
$response["terminoQuarteirao"] = $response20;
