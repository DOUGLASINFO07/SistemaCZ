...
public class BoletimDiarioActivity extends AppCompatActivity {
    ...
    String URLSalvar = "http://www.dimtech.com.br/sistemacz/focal/salvarBoletimDiario.php";
    String URLListarBairro = "http://www.dimtech.com.br/sistemacz/focal/listarBairro.php";
    String URLListarCiclo = "http://www.dimtech.com.br/sistemacz/focal/listarCiclo.php";
    String URLListarBoletimDiario = "http://www.dimtech.com.br/sistemacz/focal/listarBoletimDiario.php";
    String URLCorrigir = "http://www.dimtech.com.br/sistemacz/focal/corrigirBoletimDiario.php";
    String URLExcluir = "http://www.dimtech.com.br/sistemacz/focal/apagarBoletimDiario.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        numeroQuarteirao = (EditText) findViewById(R.id.editTextNumeroQuarteirao);
        ladoQuarteirao = (EditText) findViewById(R.id.editTextLadoQuarteirao);
        ...
        textViewNumeroQuateirao = (TextView) findViewById(R.id.textViewNumeroQuarteirao);
        ...
        textViewSequencia = (TextView) findViewById(R.id.textViewSequencia);
        textViewComplemento = (TextView) findViewById(R.id.textViewComplemento);
        textViewTipoVisita = (TextView) findViewById(R.id.textViewTipoVisita);
        ...
        if (b != null) {
            ...
            //BLOQUEIA DADOS QUE SÃO UTILIZADOS PARA CONSULTA NO BANCO.
        ...
        buttonCorrigir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(BoletimDiarioActivity.this);
                //define o titulo
    ...
    public void onBackPressed() {
        ...
        builder.setPositiveButton("SIM, VOU SAIR!", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface arg0, int arg1) {
                ...
                Intent intent = new Intent(BoletimDiarioActivity.this, TelaPrincipalActivity.class);
